		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Anubhav Workflow start ui",
									"targetURL": "#comeyworkflowuistrt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comeyworkflowuistrt-display": {
								"semanticObject": "comeyworkflowuistrt",
								"action": "display",
								"description": "Anubhav Workflow start ui",
								"title": "Anubhav Workflow start ui",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ey.workflowuistrt",
									"url": sap.ui.require.toUrl("com/ey/workflowuistrt")
								}
							}
						}
					}
